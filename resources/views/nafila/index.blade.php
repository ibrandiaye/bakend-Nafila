                    ...
                    @foreach ($nafilas as $nafila)
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::open(['method' => 'DELETE', 'route'=>['nafila.destroy', $nafila->id], 'style'=> 'display:inline', 'onclick'=>"if(!confirm('Êtes-vous sûr de vouloir supprimer cet enregistrement ?')) { return false; }"]) !!}
