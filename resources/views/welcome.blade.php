...
<head>
    ...
    <!-- <title>AdminLTE 6 | Dashboard</title> -->
     <title>Nafila  @yield('title')</title>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('nafila.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>AJouter Nafila</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('nafila.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Liste Jour</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('rakka.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>AJouter Rakka</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('rakka.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Liste Jour</p>
                                </a>
                            </li>
...
<script src="{!! asset('https://cdn.datatables.net/buttons/1.6.5/js/dataTables.buttons.min.js') !!}"></script>
<script src="{!! asset('https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js') !!}"></script>
<script src="{!! asset('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js') !!}"></script>
<script src="{!! asset('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js') !!}"></script>
<script src="{!! asset('https://cdn.datatables.net/buttons/1.6.5/js/buttons.html5.min.js') !!}"></script>
<script src="{!! asset('https://cdn.datatables.net/buttons/1.6.5/js/buttons.print.min.js') !!}"></script>
<script>
    $(function () {
        $("#example1").DataTable({
            "paging": true,
